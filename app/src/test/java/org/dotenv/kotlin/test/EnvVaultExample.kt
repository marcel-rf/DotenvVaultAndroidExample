...
class EnvVaultExample {
    ...
    fun verifyDecryptionOfVaultWithActualKey() {
        ...
        /**
         * KEY
         * marcel@aconcagua:~/dev/dotenv/testproject$ cat .env.keys
         ...
         */
        /*
            encrypted message in vault file:
...
//        val encryptedMessage = encrypt(secretKey, message)
        ...
        //val decodedEncryptedMessage = encryptedMessage.toByteArray(charset("UTF-8"))
